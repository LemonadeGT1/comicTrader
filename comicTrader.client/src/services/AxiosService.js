...
const ts = new Date
const privateKey = '032d216e909d641485f9d8cc75fda252b0464923'
const apikey = 'ae5e47d3a758598e7125c9a11f835a95'
...
function md5(inputString) {
  ...
  const fullHash = rh(a) + rh(b) + rh(c) + rh(d);
  logger.log(ts, apikey, fullHash)
  return fullHash
}
//#endregion
